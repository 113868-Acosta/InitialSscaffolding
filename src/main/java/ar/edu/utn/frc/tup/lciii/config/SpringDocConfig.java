 ...
 */
@ConfigurationProperties(prefix = "app") // prefix busca en la confi. todo lo que tenga el prefico app.
@Data
public class SpringDocConfig {
    ...
    public OpenAPI openApi (
             ...
             */
        @Value("${app.name}") String appName,  // toma los valores de aplication properties
